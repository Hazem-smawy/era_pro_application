...
class AuthRemoteDatasourceImp implements AuthRemoteDatasource {
  ...
  //   required String password,
  // }) async {
  //   String? token = sharedPreferencesService.getString(
  //     SharedPrefKeys.REFRESHTOKEN_KEY,
  //   );
  //   String? refreshToken = sharedPreferencesService.getString(
  //     SharedPrefKeys.REFRESHTOKEN_KEY,
  //   );
  ...
  //   Map<String, String?> deviceInfo = await DeviceInfo.initPlatformState();
  ...
  //     "user": {
  //       "username":
  //           token == null ? EncrypterUtils.encrypt(plainText: username) : '',
  //       "password":
  //           token == null ? EncrypterUtils.encrypt(plainText: password) : '',
  //     },
  //     "deviceInfo": {
